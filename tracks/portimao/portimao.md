...
<!-- Narrative content for the apex circuit page. Licensed CC-BY-SA 4.0 (see
     ...
     `portimao.yaml`; add sources here too if this file introduces facts the
     record does not already cite. -->

The Autódromo Internacional do Algarve opened in 2008 in the hills above
...
## The plunge into Turn 1

The circuit's signature moment is the approach to Turn 1: the long main straight
drops downhill into a heavy braking zone, compresses the cars at the bottom of
the dip, then climbs away again on the exit of the medium-speed right-hander. It
is the best overtaking spot on the lap and the corner where the track's
three-dimensional character is most obvious. Lewis Hamilton set the Formula 1
race lap record here in 2020 at 1:18.750.

## Blind crests and the high point
...
<!-- Expand with the World Superbike and MotoGP history, the Craig Jones memorial
     corner, and the circuit's role in modern endurance racing during intake. Each
     new factual claim should be backed by a source (record-level or inline). -->
