...
<!-- Narrative content for the apex circuit page. Licensed CC-BY-SA 4.0 (see
     ...
     `road-atlanta.yaml`; add sources here too if this file introduces facts the
     record does not already cite. -->

Road Atlanta opened on September 13, 1970 on a wooded 750-acre tract near
...
Road Atlanta's identity is its final corner. After the slow Turn 7 launches the
cars down a back straight close to a mile long, the Turn 10 chicane and the
blind crest of Turn 11 set up the signature plunge: Turn 12, a fast, diving
right-hander that drops sharply onto the front straight. Approached
blind and flat-out, it has collected countless cars over the decades and remains
one of the most dramatic finishing corners anywhere.

<!-- Expand with class-by-class history (IMSA / Petit Le Mans, the ALMS era,
     IndyCar, MotoAmerica), the chicane-configuration history, and lap records
     during intake. Each new factual claim should be backed by a source
