...
<!-- Narrative content for the apex circuit page. Licensed CC-BY-SA 4.0 (see
     ...
     `mosport.yaml`; add sources here too if this file introduces facts the
...
dramatically across the lap, making it one of the fastest and most committing
...
the Formula One lap record in 1977.

<!-- Expand with class-by-class history (Can-Am, Formula One, IMSA/sports cars,
     superbikes), the Moss Corner redesign story, and the 2011 renovation +
     renaming during intake. Each new factual claim should be backed by a
